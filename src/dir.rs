...
pub fn ext4_mkdir(path: &str) -> Result<(), i32> {
    let c_path = CString::new(path).unwrap();
...
pub fn ext4_rmdir(path: &str) -> Result<(), i32> {
    let c_path = CString::new(path).unwrap();
...
pub fn ext4_rmfile(path: &str) -> Result<(), i32> {
    let c_path = CString::new(path).unwrap();
...
pub fn ext4_movedir(old_path: &str, new_path: &str) -> Result<(), i32> {
...
pub fn ext4_movefile(old_path: &str, new_path: &str) -> Result<(), i32> {
    let c_old_path = CString::new(old_path).unwrap();
    let c_new_path = CString::new(new_path).unwrap();
